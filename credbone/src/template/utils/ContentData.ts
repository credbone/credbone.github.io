...
import list_res_9 from  "../../styles/images/samples/ai_res/res-31.webp";
import list_res_10 from "../../styles/images/samples/ai_res/res-30.webp";


export const ContentData = [
  { key: "1",  count: 17, image: list_res_1,   title: "Golden Whispers", description: "A young woman in warm golden and teal light, evoking tranquility.", long_description: "This portrait captures a serene moment of contemplation, bathed in dramatic sunlight and soft teal shadows. The interplay of light and shade reflects a balance of warmth and introspection." },
  { key: "2",  count: 19, image: list_res_2,   title: "Radiance in Shadows", description: "A bold silhouette under dappled orange and teal light.", long_description: "The striking portrait emphasizes strength and elegance, as vivid light patterns dance across her skin. Her gaze carries confidence, set against the ethereal glow of warm hues." },
  { key: "3",  count: 23, image: list_res_3,   title: "Eclipsed Glow", description: "A close-up of a shaved-head model in soft orange lighting.", long_description: "This minimalist portrait highlights the raw beauty of simplicity. The gentle gradient of light and shadow frames her features, enhancing her quiet strength and grace." },
  { key: "4",  count: 29, image: list_res_4,   title: "Floral Serenity", description: "A woman surrounded by soft florals and natural light.", long_description: "Delicate blossoms complement the subject's poised expression. The muted colors and natural light create a harmonious balance of softness and sophistication." },
  { key: "5",  count: 31, image: list_res_5,   title: "Sunlit Gaze", description: "A contemplative glance caught in golden sun rays.", long_description: "This image captures the intimacy of a fleeting moment. Striking contrasts of sunlight and shadow highlight the subject's reflective expression, drawing the viewer into her world." },
