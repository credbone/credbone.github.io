...
import sampleImage_3 from "../styles/images/samples/res_3.webp";
...
data-over-color="none"
  ...
  <path d='M80,57.5Q76,65,74,77Q72,89,61,85.5Q50,82,42.5,79Q35,76,24.5,73.5Q14,71,8.5,60.5Q3,50,11,41Q19,32,24.5,23.5Q30,15,40,11Q50,7,60.5,10.5Q71,14,74.5,24Q78,34,81,42Q84,50,80,57.5Z' fill='none' stroke='currentColor' />
          ...
          <svg width="100%" height="100%" data-position="absolute">
            ...
            <rect data-animation-name="pattern-move" data-animation-timing="linear" data-animation-duration="16" data-animation-play-state="running-hover" data-animation-interation="infinite" width="200%" height="200%" fill="url(#combined-svg-38)" ></rect>
          </svg>
        </group>
