...
data-ellipsis=""
                      ...
                      <text
                       ...
                       data-opacity="60"
                      >
                        Navigation bars allow movement between primary
                  ...
                  {navData.map((item) => (
                    <Ripple key={item.key}>
                      <group
                        ...
                        data-background={
                          item.key === selectedItemKey ? "main" : ""
                        }
                        data-color={
                          item.key === selectedItemKey ? "main-text" : ""
                        }
                        data-ink-color={
                    ...
                    {navData.map((item2) => (
                      <Ripple key={item2.key}>
                        ...
                        >
                          <icon
                            data-fill={
                              item2.key === selectedItem2Key ? "fill" : ""
                            }
                          >
                            {item2.icon}
                          </icon>
