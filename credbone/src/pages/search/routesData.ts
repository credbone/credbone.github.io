...
export const routesData: RouteData[] = [
  ...
  { path: "Miscellaneous", tags: ["miscellaneous", "marquee", "counter"], description: "Encompasses a variety of small, diverse UI components that don't fit into other categories, including elements like marquees and counters.", title: "Miscellaneous" },
];
