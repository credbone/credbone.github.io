...
const routeTitles: {
  [key: string]: { title: string | null; header: string | null };
} = {
...
const TitleUpdater: React.FC = () => {
  ...
  useEffect(() => {
    ...
    document.title = routeTitles[lastSegment]?.title
      ? `${routeTitles[lastSegment]?.title} - Credbone`
      : "Credbone"; // Update browser title
    setHeader(newHeader);
  }, [location]);
