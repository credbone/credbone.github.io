...
export const IconDelete: React.FC<IconProps> = ({fill = false,stroke = 2,...restProps}) => {
  return (

  <Icon {...restProps}>
 <path  stroke="currentColor" strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round"
