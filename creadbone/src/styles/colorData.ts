...
export const colors = [
  ...
  { code: "#e89468", name: "Orange", description: "A warm orange shade." },
...
export const seccolors = [
  { code: "#ec5b55", name: "Crimson", description: "A deep red color." },
  { code: "#f08c34", name: "Orange", description: "A bright orange hue." },
  ...
  { code: "#fb8500", name: "Tangerine", description: "A vibrant tangerine shade." },
